...
const validation = {
  firstName: yup.string()
    ...
    .matches(/[^\s]/, 'First Name should not contain gap')
    .min(2, 'First Name must be longer')
    .max(10, 'First Name must be shorter'),
  lastName: yup.string()
    .matches(/^([^0-9]*)$/, 'Last Name should not contain numbers')
    .matches(/[^\s]/, 'Last Name should not contain gap')
    .min(2, 'Last Name must be longer')
    .max(10, 'Last name must be shorter'),
